...
local lovebird = { _version = "0.4.3-fork" }

lovebird.loadstring = loadstring or load
lovebird.loaded = false
lovebird.host = "*"
lovebird.buffer = ""
lovebird.lines = {}
...
<html>
  ...
  <style>
    body {
      margin: 0px;
      font-size: 14px;
      font-family: helvetica, veranda, sans;
      background: #FFFFFF;
    }
    form {
      margin-bottom: 0px;
...
function lovebird.trace(...)
  local str = "[lovebird] "
    .. table.concat(lovebird.map({ ... }, tostring), " ")
  print(str)
...
function lovebird.onrequest(req)
...
function lovebird.onconnect(client)
  ...
  req.headers = {}
  while 1 do
    local line = lovebird.receive(client, "*l")
